...
public class TestModVillagerProfessions {
	...
	public static final RegistryObject<VillagerProfession> HACKER = registerProfession("hacker", () -> Blocks.EMERALD_BLOCK, () -> ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("test:typer_short")));
